...
int fp_minutia_get_coords(struct fp_minutia *minutia, int *coord_x, int *coord_y, int *ex, int *ey, int *coord_direction, double *reliability, int *type, int *appearing, int * feature_id);
